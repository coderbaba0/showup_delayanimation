...
class _MyHomePageState extends State<MyHomePage> {
  int delayAmount = 100;
  Map<String, String> map1 = {"0": 'click on me', "1": "me too", "2": "Twoo"};
  int selectedIndex = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            ShowUp(
              child: Text("an  show in demo",style: TextStyle(color: Colors.purple,fontSize: 35)),
              delay: delayAmount,
            ),
            ShowUp(
            ...
            ShowUp(
              child: Column(
                children: <Widget>[
                  ...
                  Text("Texts   flutterfever.com",style: TextStyle(color: Colors.purple,fontSize: 15)),
                ],
              ),
